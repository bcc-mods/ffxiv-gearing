...
export const Store = mst.types
  .model('Store', {
    ...
    minFoodLevel: mst.types.optional(mst.types.number, G.getMinFoodLevel()),
    maxFoodLevel: mst.types.optional(mst.types.number, G.getMaxFoodLevelByVersion(__PATCH__)),
